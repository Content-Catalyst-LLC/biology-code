"""
Biological network order workflow.
...
NETWORK_PATH = ARTICLE_DIR / "data" / "network_edges.csv"


def main() -> None:
    """Summarize simple biological interaction network."""
        ...
        centrality_rows.append(
            {
                ...
                "mean_interaction_weight": float(edges.loc[mask, "interaction_weight"].mean()),
            }
        )
    ...
    print(type_summary.round(3).to_string(index=False))
