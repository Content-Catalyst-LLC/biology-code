"""
Calculate validation metrics for predicted system response.
...
from systems_biology_core import validation_metrics
...
def main() -> None:
    ...
    metrics = validation_metrics(validation["observed_response"], validation["predicted_response"])
