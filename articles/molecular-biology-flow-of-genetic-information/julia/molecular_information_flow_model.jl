# Molecular information-flow model in Julia.
...
function mutation_rate(mutations, genomes, sites, generations)
...
println("mutation_rate=", mutation_rate(12.0, 1000.0, 100000.0, 1.0))
