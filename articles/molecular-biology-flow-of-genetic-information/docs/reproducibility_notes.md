...
All example datasets in `data/` are synthetic and small. They demonstrate structure rather than represent real molecular, transcriptomic, clinical, ecological, sequencing, or diagnostic measurements.
...
- molecular flow condition sites
- model outputs
- data source
- analytical method
- license
